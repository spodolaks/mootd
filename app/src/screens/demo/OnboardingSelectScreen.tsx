...
export const OnboardingSelectScreen: React.FC = () => {
...
const styles = StyleSheet.create({
  ...
  description: {
    // Uses theme's primary label color with body variant
  },
  itemsContainer: {
    gap: 8,
  },
  ...
  button: {
    marginBottom: 32, // Extra margin to accommodate the glow effect
  },
});
